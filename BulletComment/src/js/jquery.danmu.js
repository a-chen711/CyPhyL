...
(function ($) {
    ...
    Danmu.prototype.addDanmu = function (arg) {
        ...
        $.ajax({
            type: "POST",
            url: "stone.php",
            data: {'function': 'send','message': this.$element.data('text'),'file': file}, //I believe the this.$element.data('text') will give the message text? I'm not sure
            dataType: "json",                                                              //'file': file portion causes problems as well
        });
    };
