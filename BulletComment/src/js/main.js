...
(function ($) {
    ...
    var DanmuPlayer = function (element, options) {
        ...
        //this.$ctrlMain.append('<div class="volume  ctrl-btn-right ctrl-btn-right-active"><span class="glyphicon glyphicon-volume-up" aria-hidden="true"></span></div>');
        ...
        this.volumeMuted = false; //true = muted
        this.isLoop = false;
        this.danmuSize = 0;
